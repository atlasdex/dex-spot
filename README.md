...
[Atlas Spot Dex](https://beta.atlasdex.finance/)
An implementation of a UI for the Atlas DEX.
...
See [A technical introduction to the Atlas DEX](https://docs.google.com/document/d/1isGJES4jzQutI0GtQGuqtrBUqeHxl_xJNXdtOv4SdII/view) to learn more about the Atlas DEX.

See [serum-js](https://github.com/project-serum/serum-js) for DEX client-side code. Atlas DEX UI uses this library.

See [sol-wallet-adapter](https://github.com/project-serum/sol-wallet-adapter) for an explanation of how the Atlas DEX UI interacts with wallet services to sign and send requests to the Atlas DEX.
