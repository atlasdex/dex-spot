...
import { AddTxnInLeaderboard, getDecimalCount, sleep } from './utils';
...
const addTxnInLeader = async (publicKey, price) => {
  try {
    const response = await AddTxnInLeaderboard(publicKey, price);
    console.log('txn added in leaderBoard', response);
  } catch (error) {
    console.log('error from leader board', error);
  }
};
...
export async function sendSignedTransaction({
  ...
  if (sendNotification) {
    ...
    addTxnInLeader(walletAddres, quoteSize);
  }
