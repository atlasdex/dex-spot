...
import { AddTxnInLeaderboard } from './utils';
...
let warText = 'Transaction was not confirmed in 10.00 seconds';
...
export const swap = async (
  ...
  // try {
  // } catch (error) {
  //   if (error.message !== undefined && error.message === warText) {
  //     console.log(
  //       'Transaction Excuted Successfully with Waring ',
  //       error.message,
  //     );
  //     notify({
