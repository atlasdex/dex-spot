...
import {AddTxnInLeaderboard, floorToDecimal, getDecimalCount, roundToDecimal,} from '../utils/utils';
...
export default function TradeForm({
  ...
  const walletAddres = (connected && wallet?.publicKey?.toBase58()) || '';
  ...
  return (
    ...
    >
      <div style={{ flex: 1 }}>
        ...
        >
          <Radio.Button
            ...
            style={{
              width: '50%',
              textAlign: 'center',
              color: side === 'buy' ? 'rgb(0, 0, 0)' : 'white',
              // borderRadius : '10px 0px 0px 10px',
              background: side === 'buy' ? 'rgb(119 189 160)' : '',
          ...
          <Radio.Button
            ...
            style={{
              width: '50%',
              textAlign: 'center',
              color: side === 'sell' ? 'rgb(0, 0, 0)' : 'white',
              // borderRadius : '0px 10px 10px 0px',
              background: side === 'sell' ? 'rgb(249 128 128)' : '',
        ...
        <Input
          style={{ textAlign: 'right', paddingBottom: 8 , color: 'white' }}
          addonBefore={<div style={{ width: '30px' , color: 'white' }}>Price</div>}
          suffix={
            <span style={{ fontSize: 10, opacity: 0.5 , color: 'white'}}>{quoteCurrency}</span>
          }
          className={'input-ds'}
          value={price}
          type="number"
        ...
        <Input.Group compact style={{ paddingBottom: 8 }}>
          <Input
            style={{ width: 'calc(50% + 30px)', textAlign: 'right' , color: 'white' }}
            addonBefore={<div style={{ width: '30px' , color: 'white' }}>Size</div>}
            suffix={
              <span style={{ fontSize: 10, opacity: 0.5 , color: 'white' }}>{baseCurrency}</span>
            }
            value={baseSize}
            type="number"
          ...
          <Input
            style={{ width: 'calc(50% - 30px)', textAlign: 'right' , color: 'white' }}
            suffix={
              <span style={{ fontSize: 10, opacity: 0.5 , color: 'white' }}>
                {quoteCurrency}
              </span>
            }
            value={quoteSize}
